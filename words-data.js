...
const WORD_LIST = [
  ...
  { en: "floor", ja: "ゆか,階", kana: ["かい"], emoji: "🏢", ex: "My room is on the third floor.", exJa: "わたしの へやは 3かいです。" },
  ...
  { en: "page", ja: "(本の)ページ", kana: ["ぺーじ"], emoji: "📄", ex: "Open your book to page ten.", exJa: "本ほんの 10ページを ひらいて。" },
  ...
  { en: "test", ja: "テスト,試験", kana: ["しけん"], emoji: "📋", ex: "I have a test today.", exJa: "きょう テストが あります。" },
  ...
  { en: "ground", ja: "地面,グラウンド,運動場", kana: ["じめん", "うんどうじょう"], emoji: "🏟️", ex: "We play on the ground.", exJa: "わたしたちは グラウンドで あそびます。" },
  { en: "history", ja: "歴史", kana: ["れきし"], emoji: "📜", ex: "I like history.", exJa: "わたしは れきしが すきです。" },
  { en: "idea", ja: "考え,アイデア,見当", kana: ["かんがえ", "けんとう"], emoji: "💡", ex: "That's a good idea.", exJa: "それは いい かんがえですね。" },
  { en: "children", ja: "子どもたち(childの複数形)", kana: ["こどもたち"], emoji: "🧒", ex: "Many children are here.", exJa: "たくさんの 子どもが ここに います。" },
  ...
  { en: "cook", ja: "料理する,コック", kana: ["りょうりする"], emoji: "🍳", ex: "My father is a cook.", exJa: "わたしの おとうさんは りょうりにんです。" },
  { en: "lady", ja: "ご婦人,女のかた", kana: ["ごふじん", "おんなのかた"], emoji: "👩", ex: "That lady is my teacher.", exJa: "あの ご婦人は わたしの 先生せんせいです。" },
  ...
  { en: "meat", ja: "肉", kana: ["にく"], emoji: "🍖", ex: "I like meat.", exJa: "わたしは にくが すきです。" },
  ...
  { en: "score", ja: "点数,得点,スコア,得点する", kana: ["てんすう", "とくてん"], emoji: "🔢", ex: "What is the score?", exJa: "てんすうは いくつですか。" },
  ...
  { en: "easy", ja: "やさしい,簡単な,気楽な", kana: ["かんたんな", "きらくな"], emoji: "😀", ex: "This test is easy.", exJa: "この テストは かんたんです。" },
  { en: "happy", ja: "幸せな,うれしい", kana: ["しあわせな"], emoji: "😊", ex: "I am happy.", exJa: "わたしは うれしいです。" },
  ...
  { en: "first", ja: "最初,最初の,最初に,1番目の", kana: ["さいしょ", "さいしょの", "いちばんめの"], emoji: "🥇", ex: "This is my first time.", exJa: "これが はじめてです。" },
  { en: "second", ja: "2番目,第2の,秒", kana: ["にばんめ", "だいにの", "びょう"], emoji: "🥈", ex: "This is my second book.", exJa: "これは 2さつめの 本ほんです。" },
  { en: "third", ja: "3番目,第3の", kana: ["さんばんめ", "だいさんの"], emoji: "🥉", ex: "This is my third try.", exJa: "これで 3かいめです。" },

  // ===== 531〜540 =====
  { en: "fourth", ja: "4番目の", kana: ["よんばんめの"], emoji: "🔢", ex: "I am in fourth grade.", exJa: "わたしは 4ねんせいです。" },
  { en: "fifth", ja: "5番目の", kana: ["ごばんめの"], emoji: "🔢", ex: "This is the fifth question.", exJa: "これは 5もんめです。" },
  { en: "sixth", ja: "6番目の", kana: ["ろくばんめの"], emoji: "🔢", ex: "This is the sixth day.", exJa: "きょうで 6にちめです。" },
  { en: "seventh", ja: "7番目の", kana: ["ななばんめの"], emoji: "🔢", ex: "Today is the seventh.", exJa: "きょうは 7かです。" },
  { en: "eighth", ja: "8番目の", kana: ["はちばんめの"], emoji: "🔢", ex: "Today is the eighth.", exJa: "きょうは 8かです。" },
  { en: "ninth", ja: "9番目の", kana: ["きゅうばんめの"], emoji: "🔢", ex: "Today is the ninth.", exJa: "きょうは 9かです。" },
  { en: "tenth", ja: "10番目の", kana: ["じゅうばんめの"], emoji: "🔢", ex: "Today is the tenth.", exJa: "きょうは 10かです。" },
  { en: "eleventh", ja: "11番目の", kana: ["じゅういちばんめの"], emoji: "🔢", ex: "Today is the eleventh.", exJa: "きょうは 11にちです。" },
  { en: "twelfth", ja: "12番目の", kana: ["じゅうにばんめの"], emoji: "🔢", ex: "Today is the twelfth.", exJa: "きょうは 12にちです。" },
