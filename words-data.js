...
const WORD_LIST = [
  ...
  { en: "leg", ja: "あし(脚)", emoji: "🦵", ex: "My legs are long.", exJa: "わたしの あしは ながいです。" },
  ...
  { en: "see", ja: "みる,あう,みえる", emoji: "👀", ex: "I see a bird.", exJa: "とりが みえます。" },
  { en: "eat", ja: "たべる", emoji: "🍽️", ex: "I eat breakfast.", exJa: "わたしは あさごはんを たべます。" },
  { en: "read", ja: "よむ", emoji: "📖", ex: "I read a book.", exJa: "わたしは ほんを よみます。" },
  { en: "look", ja: "みる,～にみえる", emoji: "👁️", ex: "Look at this.", exJa: "これを みて。" },
  { en: "watch", ja: "じっとみる", emoji: "📺", ex: "I watch TV.", exJa: "わたしは テレビを みます。" },
  ...
  { en: "listen", ja: "きく,みみをかたむける", emoji: "👂", ex: "I listen to music.", exJa: "わたしは おんがくを ききます。" },
  ...
  { en: "cook", ja: "りょうりする,コック", emoji: "🍳", ex: "I cook dinner.", exJa: "わたしは ばんごはんを つくります。" },
  { en: "start", ja: "しゅっぱつする,はじめる", emoji: "🏁", ex: "The class starts at nine.", exJa: "じゅぎょうは 9じに はじまります。" },
  { en: "talk", ja: "はなす,はなし", emoji: "💬", ex: "I talk with my friend.", exJa: "わたしは ともだちと はなします。" },
  { en: "teach", ja: "おしえる", emoji: "🧑‍🏫", ex: "My mother teaches math.", exJa: "わたしの ははは さんすうを おしえています。" },

  // ===== 221〜230 =====
  { en: "clean", ja: "きれいにする,そうじする,せいけつな", emoji: "🧹", ex: "I clean my room.", exJa: "わたしは へやを そうじします。" },
  { en: "help", ja: "たすける,てつだう,たすけ", emoji: "🤝", ex: "I help my mother.", exJa: "わたしは ははを てつだいます。" },
  ...
  { en: "dance", ja: "おどる,ダンス", emoji: "💃", ex: "I like to dance.", exJa: "わたしは おどるのが すきです。" },
  ...
  { en: "stop", ja: "とまる,とめる,やめる", emoji: "🛑", ex: "Stop here.", exJa: "ここで とまって。" },
  { en: "enjoy", ja: "たのしむ", emoji: "😊", ex: "I enjoy this game.", exJa: "わたしは この ゲームを たのしみます。" },
  { en: "practice", ja: "れんしゅうする,れんしゅう", emoji: "🎯", ex: "I practice soccer every day.", exJa: "わたしは まいにち サッカーを れんしゅうします。" },
  ...
  { en: "nice", ja: "やさしい,よい,すてきな", emoji: "😊", ex: "You are nice.", exJa: "あなたは すてきです。" },
  ...
  { en: "great", ja: "いだいな,じゅうだいな,すばらしい", emoji: "🌟", ex: "That's great!", exJa: "すばらしい!" },
  ...
  { en: "beautiful", ja: "うつくしい,すばらしい", emoji: "🌅", ex: "The sunset is beautiful.", exJa: "ゆうやけは うつくしいです。" },
  ...
  { en: "wonderful", ja: "すばらしい,おどろくべき", emoji: "🤩", ex: "That's wonderful!", exJa: "すばらしい!" },
  ...
  { en: "what", ja: "何,何の", emoji: "❓", ex: "What is this?", exJa: "これは なんですか。" },
  ...
  { en: "one", ja: "1つ,1人,もの", emoji: "1️⃣", ex: "I have one apple.", exJa: "わたしは りんごを 1つ もっています。" },
  { en: "every", ja: "あらゆる,～ごとに,すべての", emoji: "💯", ex: "I study every day.", exJa: "わたしは まいにち べんきょうします。" },
  { en: "some", ja: "いくつか,いくらか,多少", emoji: "🔢", ex: "I have some pens.", exJa: "わたしは ペンを いくつか もっています。" },
  { en: "many", ja: "多くの,たくさんの", emoji: "🔢", ex: "I have many friends.", exJa: "わたしは ともだちが たくさん います。" },
  { en: "all", ja: "すべての,全部,あらゆる", emoji: "💯", ex: "I know all the answers.", exJa: "わたしは こたえを ぜんぶ しっています。" },
  { en: "any", ja: "いくらかの,少しも,どんな～でも", emoji: "❓", ex: "Do you have any pens?", exJa: "ペンを もっていますか。" },
  { en: "Mr.", ja: "～さん,～先生(男性)", emoji: "🧑", ex: "This is Mr. Smith.", exJa: "こちらは スミスさんです。" },
  { en: "Ms.", ja: "～さん,～先生(女性)", emoji: "👩", ex: "This is Ms. Smith.", exJa: "こちらは スミスさんです。" },
  { en: "chair", ja: "いす", emoji: "🪑", ex: "Sit on the chair.", exJa: "いすに すわって。" },

  // ===== 321〜330 =====
  { en: "magazine", ja: "雑誌", emoji: "📰", ex: "I read a magazine.", exJa: "わたしは ざっしを よみます。" },
  { en: "phone", ja: "電話", emoji: "📞", ex: "This is my phone.", exJa: "これは わたしの でんわです。" },
  { en: "bathroom", ja: "浴室,トイレ", emoji: "🚽", ex: "Where is the bathroom?", exJa: "トイレは どこですか。" },
  { en: "hat", ja: "帽子(ふちのある)", emoji: "🎩", ex: "I have a new hat.", exJa: "わたしは あたらしい ぼうしを もっています。" },
  { en: "cup", ja: "カップ,茶わん", emoji: "☕", ex: "This is my cup.", exJa: "これは わたしの カップです。" },
  { en: "kitchen", ja: "台所", emoji: "🍳", ex: "My mother is in the kitchen.", exJa: "おかあさんは だいどころに います。" },
  ...
  { en: "garden", ja: "庭,庭園", emoji: "🌷", ex: "I like this garden.", exJa: "わたしは この にわが すきです。" },
  { en: "bedroom", ja: "寝室", emoji: "🛏️", ex: "This is my bedroom.", exJa: "これは わたしの しんしつです。" },

  // ===== 331〜340 =====
  { en: "newspaper", ja: "新聞", emoji: "📰", ex: "My father reads the newspaper.", exJa: "おとうさんは しんぶんを よみます。" },
  ...
  { en: "floor", ja: "ゆか,階", emoji: "🏢", ex: "My room is on the third floor.", exJa: "わたしの へやは 3かいです。" },
  { en: "glove", ja: "手袋,グローブ", emoji: "🧤", ex: "I have new gloves.", exJa: "わたしは あたらしい てぶくろを もっています。" },
  { en: "living room", ja: "居間,リビングルーム", emoji: "🛋️", ex: "We watch TV in the living room.", exJa: "わたしたちは リビングで テレビを みます。" },
  { en: "shoe", ja: "靴", emoji: "👟", ex: "I have new shoes.", exJa: "わたしは あたらしい くつを もっています。" },
  { en: "jacket", ja: "上着,ジャケット", emoji: "🧥", ex: "I like this jacket.", exJa: "わたしは この うわぎが すきです。" },
  { en: "postcard", ja: "はがき,絵はがき", emoji: "💌", ex: "I write a postcard.", exJa: "わたしは はがきを かきます。" },
  { en: "shower", ja: "シャワー,にわか雨", emoji: "🚿", ex: "I take a shower.", exJa: "わたしは シャワーを あびます。" },
  ...
  { en: "diary", ja: "日記,日記帳", emoji: "📔", ex: "I write in my diary.", exJa: "わたしは にっきを かきます。" },
  { en: "dining room", ja: "食堂,ダイニングルーム", emoji: "🍽️", ex: "We eat in the dining room.", exJa: "わたしたちは ダイニングで たべます。" },
  ...
  // ===== 351〜360 =====
  { en: "coat", ja: "コート(衣服の)", emoji: "🧥", ex: "I wear a coat in winter.", exJa: "わたしは ふゆに コートを きます。" },
  ...
  { en: "toy", ja: "おもちゃ", emoji: "🧸", ex: "I like this toy.", exJa: "わたしは この おもちゃが すきです。" },
  { en: "wall", ja: "壁,へい", emoji: "🧱", ex: "There is a picture on the wall.", exJa: "かべに えが あります。" },
  { en: "minute", ja: "分,瞬間", emoji: "⏱️", ex: "Wait a minute.", exJa: "ちょっと まって。" },
  { en: "pencil case", ja: "ふでばこ", emoji: "🖊️", ex: "This is my pencil case.", exJa: "これは わたしの ふでばこです。" },
  { en: "lesson", ja: "授業,けいこ,(教科書の)課", emoji: "📚", ex: "I have a piano lesson.", exJa: "わたしは ピアノの レッスンが あります。" },
  { en: "page", ja: "(本の)ページ", emoji: "📄", ex: "Open your book to page ten.", exJa: "本ほんの 10ページを ひらいて。" },
  { en: "pool", ja: "プール,水たまり", emoji: "🏊", ex: "I swim in the pool.", exJa: "わたしは プールで およぎます。" },

  // ===== 361〜370 =====
  { en: "cafeteria", ja: "カフェテリア", emoji: "🍴", ex: "We eat at the cafeteria.", exJa: "わたしたちは カフェテリアで たべます。" },
  { en: "test", ja: "テスト,試験", emoji: "📋", ex: "I have a test today.", exJa: "きょう テストが あります。" },
  { en: "PE", ja: "体育,体育科", emoji: "🏃", ex: "I like PE class.", exJa: "わたしは たいいくが すきです。" },
  { en: "ruler", ja: "定規", emoji: "📏", ex: "I use a ruler.", exJa: "わたしは じょうぎを つかいます。" },
  { en: "blackboard", ja: "黒板", emoji: "⬛", ex: "Look at the blackboard.", exJa: "こくばんを みて。" },
  { en: "ground", ja: "地面,グラウンド,運動場", emoji: "🏟️", ex: "We play on the ground.", exJa: "わたしたちは グラウンドで あそびます。" },
  { en: "history", ja: "歴史", emoji: "📜", ex: "I like history.", exJa: "わたしは れきしが すきです。" },
  { en: "idea", ja: "考え,アイデア,見当", emoji: "💡", ex: "That's a good idea.", exJa: "それは いい かんがえですね。" },
  { en: "children", ja: "子どもたち(childの複数形)", emoji: "🧒", ex: "Many children are here.", exJa: "たくさんの 子どもが ここに います。" },
  { en: "doctor", ja: "医者", emoji: "🧑‍⚕️", ex: "My mother is a doctor.", exJa: "わたしの おかあさんは いしゃです。" },

  // ===== 371〜380 =====
  { en: "pilot", ja: "パイロット", emoji: "🧑‍✈️", ex: "I want to be a pilot.", exJa: "わたしは パイロットに なりたいです。" },
  { en: "waiter", ja: "ウェイター,給仕", emoji: "🧑‍🍳", ex: "He is a waiter.", exJa: "かれは ウェイターです。" },
  { en: "cook", ja: "料理する,コック", emoji: "🍳", ex: "My father is a cook.", exJa: "わたしの おとうさんは りょうりにんです。" },
  { en: "lady", ja: "ご婦人,女のかた", emoji: "👩", ex: "That lady is my teacher.", exJa: "あの ご婦人は わたしの 先生せんせいです。" },
  { en: "police officer", ja: "警察官", emoji: "👮", ex: "He is a police officer.", exJa: "かれは けいさつかんです。" },
  { en: "dancer", ja: "ダンサー,踊る人", emoji: "💃", ex: "She is a great dancer.", exJa: "かのじょは すばらしい ダンサーです。" },
  { en: "nurse", ja: "看護師,看護士", emoji: "🧑‍⚕️", ex: "She is a nurse.", exJa: "かのじょは かんごしです。" },
  { en: "pianist", ja: "ピアニスト", emoji: "🎹", ex: "He is a famous pianist.", exJa: "かれは ゆうめいな ピアニストです。" },
  { en: "driver", ja: "運転手,運転者", emoji: "🚗", ex: "My father is a bus driver.", exJa: "わたしの おとうさんは バスの うんてんしゅです。" },
  { en: "firefighter", ja: "消防士", emoji: "🧑‍🚒", ex: "He is a firefighter.", exJa: "かれは しょうぼうしです。" },

  // ===== 381〜390 =====
  { en: "store", ja: "店,店をかまえる,蓄える", emoji: "🏪", ex: "I go to the store.", exJa: "わたしは みせへ いきます。" },
  { en: "supermarket", ja: "スーパーマーケット", emoji: "🛒", ex: "I go to the supermarket.", exJa: "わたしは スーパーへ いきます。" },
  { en: "office", ja: "事務所,会社,職場", emoji: "🏢", ex: "My father works at an office.", exJa: "おとうさんは かいしゃで はたらいています。" },
  { en: "department store", ja: "デパート,百貨店", emoji: "🏬", ex: "I go to the department store.", exJa: "わたしは デパートへ いきます。" },
  { en: "ship", ja: "船(大型の)", emoji: "🚢", ex: "I see a ship.", exJa: "ふねが みえます。" },
  { en: "ticket", ja: "切符,券,チケット", emoji: "🎫", ex: "I have a ticket.", exJa: "わたしは きっぷを もっています。" },
  { en: "airport", ja: "空港,飛行場", emoji: "✈️", ex: "I go to the airport.", exJa: "わたしは くうこうへ いきます。" },
  { en: "bookstore", ja: "書店", emoji: "📚", ex: "I go to the bookstore.", exJa: "わたしは しょてんへ いきます。" },
  { en: "bridge", ja: "橋", emoji: "🌉", ex: "This bridge is long.", exJa: "この はしは ながいです。" },
  { en: "building", ja: "建物,ビル", emoji: "🏢", ex: "That building is tall.", exJa: "あの たてものは たかいです。" },

  // ===== 391〜400 =====
  { en: "tower", ja: "塔,タワー", emoji: "🗼", ex: "I see a tower.", exJa: "タワーが みえます。" },
  { en: "bank", ja: "銀行,土手", emoji: "🏦", ex: "I go to the bank.", exJa: "わたしは ぎんこうへ いきます。" },
  { en: "bus stop", ja: "バス停", emoji: "🚏", ex: "I wait at the bus stop.", exJa: "わたしは バスていで まちます。" },
  ...
  { en: "plane", ja: "飛行機", emoji: "✈️", ex: "I go by plane.", exJa: "わたしは ひこうきで いきます。" },
  { en: "post office", ja: "郵便局", emoji: "🏤", ex: "I go to the post office.", exJa: "わたしは ゆうびんきょくへ いきます。" },
  { en: "police station", ja: "警察署", emoji: "🚓", ex: "The police station is near here.", exJa: "けいさつしょは この ちかくです。" },
  { en: "taxi", ja: "タクシー", emoji: "🚕", ex: "We take a taxi.", exJa: "タクシーに のります。" },
  { en: "tea", ja: "お茶,紅茶", emoji: "🍵", ex: "I drink tea.", exJa: "わたしは おちゃを のみます。" },

  // ===== 401〜410 =====
  { en: "pizza", ja: "ピザ", emoji: "🍕", ex: "I like pizza.", exJa: "わたしは ピザが すきです。" },
  { en: "plate", ja: "皿,プレート,料理", emoji: "🍽️", ex: "Put it on the plate.", exJa: "おさらに のせて。" },
  ...
  { en: "dish", ja: "皿,料理", emoji: "🍽️", ex: "This dish is delicious.", exJa: "この りょうりは おいしいです。" },
  ...
  { en: "dessert", ja: "デザート(食後の)", emoji: "🍰", ex: "I want a dessert.", exJa: "わたしは デザートが ほしいです。" },
  ...
  { en: "lunchtime", ja: "昼食時間,ランチタイム", emoji: "🍱", ex: "It is lunchtime.", exJa: "ひるごはんの じかんです。" },
  { en: "meat", ja: "肉", emoji: "🍖", ex: "I like meat.", exJa: "わたしは にくが すきです。" },
  { en: "tomato", ja: "トマト", emoji: "🍅", ex: "I like tomatoes.", exJa: "わたしは トマトが すきです。" },
  { en: "vegetable", ja: "野菜", emoji: "🥦", ex: "Eat your vegetables.", exJa: "やさいを たべなさい。" },
  { en: "carrot", ja: "にんじん", emoji: "🥕", ex: "I like carrots.", exJa: "わたしは にんじんが すきです。" },

  // ===== 421〜430 =====
  { en: "chopstick", ja: "はし(食事用の)", emoji: "🥢", ex: "I use chopsticks.", exJa: "わたしは はしを つかいます。" },
  ...
  { en: "glass", ja: "グラス,コップ,めがね", emoji: "🥛", ex: "I want a glass of water.", exJa: "みずを 1ぱい ほしいです。" },
  ...
  { en: "grandmother", ja: "祖母", emoji: "👵", ex: "My grandmother is kind.", exJa: "わたしの おばあさんは やさしいです。" },

  // ===== 431〜440 =====
  { en: "grandfather", ja: "祖父", emoji: "👴", ex: "My grandfather is 70.", exJa: "わたしの おじいさんは 70さいです。" },
  { en: "racket", ja: "ラケット", emoji: "🎾", ex: "I have a new racket.", exJa: "わたしは あたらしい ラケットを もっています。" },
  { en: "score", ja: "点数,得点,スコア,得点する", emoji: "🔢", ex: "What is the score?", exJa: "てんすうは いくつですか。" },
  { en: "softball", ja: "ソフトボール", emoji: "⚾", ex: "I play softball.", exJa: "わたしは ソフトボールを します。" },
  { en: "bicycle", ja: "自転車", emoji: "🚲", ex: "I ride a bicycle.", exJa: "わたしは じてんしゃに のります。" },
  ...
  { en: "flower", ja: "花", emoji: "🌸", ex: "This flower is beautiful.", exJa: "この はなは うつくしいです。" },
  { en: "snow", ja: "雪,雪が降る", emoji: "❄️", ex: "It is snowy today.", exJa: "きょうは ゆきです。" },
  { en: "hamster", ja: "ハムスター", emoji: "🐹", ex: "I have a hamster.", exJa: "わたしは ハムスターを かっています。" },

  // ===== 441〜450 =====
  { en: "river", ja: "川", emoji: "🌊", ex: "This river is long.", exJa: "この かわは ながいです。" },
  { en: "rose", ja: "バラ(の花)", emoji: "🌹", ex: "I like roses.", exJa: "わたしは バラが すきです。" },
  { en: "sea", ja: "海", emoji: "🌊", ex: "I like the sea.", exJa: "わたしは うみが すきです。" },
  { en: "sky", ja: "空", emoji: "☁️", ex: "The sky is blue.", exJa: "そらは あおいです。" },
  { en: "weather", ja: "天気,天候", emoji: "⛅", ex: "How is the weather today?", exJa: "きょうの てんきは どうですか。" },
  { en: "beach", ja: "砂浜,浜辺", emoji: "🏖️", ex: "I like the beach.", exJa: "わたしは はまべが すきです。" },
  ...
  // ===== 451〜460 =====
  { en: "purple", ja: "紫の,紫色", emoji: "🟣", ex: "I like purple.", exJa: "わたしは むらさきが すきです。" },
  { en: "concert", ja: "音楽会,演奏会,コンサート", emoji: "🎤", ex: "I go to a concert.", exJa: "わたしは コンサートへ いきます。" },
  { en: "flute", ja: "フルート", emoji: "🎶", ex: "I play the flute.", exJa: "わたしは フルートを ふきます。" },
  { en: "party", ja: "パーティー,集団,政党", emoji: "🎉", ex: "I have a birthday party.", exJa: "わたしは たんじょうびパーティーを します。" },
  { en: "meter", ja: "メートル", emoji: "📏", ex: "This is one meter long.", exJa: "これは 1メートルの ながさです。" },
  { en: "yen", ja: "円", emoji: "💴", ex: "It is one hundred yen.", exJa: "100えんです。" },
  ...
  { en: "French", ja: "フランス人,フランス語,フランスの", emoji: "🇫🇷", ex: "I study French.", exJa: "わたしは フランスごを べんきょうします。" },

  // ===== 461〜470 =====
  { en: "Singapore", ja: "シンガポール", emoji: "🇸🇬", ex: "I want to go to Singapore.", exJa: "わたしは シンガポールへ いきたいです。" },
  { en: "world", ja: "世界", emoji: "🌍", ex: "I want to see the world.", exJa: "わたしは せかいを みたいです。" },
  { en: "foot", ja: "足,フィート,ふもと", emoji: "🦶", ex: "My foot is big.", exJa: "わたしの あしは おおきいです。" },
  { en: "ear", ja: "耳", emoji: "👂", ex: "The rabbit has long ears.", exJa: "うさぎは みみが ながいです。" },
  { en: "shoulder", ja: "肩", emoji: "🤷", ex: "My shoulder hurts.", exJa: "かたが いたいです。" },
  { en: "buy", ja: "～を買う", emoji: "🛍️", ex: "I buy a book.", exJa: "わたしは 本ほんを かいます。" },
  { en: "cut", ja: "～を切る", emoji: "✂️", ex: "I cut the paper.", exJa: "わたしは かみを きります。" },
  { en: "sleep", ja: "眠る,眠り,睡眠", emoji: "😴", ex: "I sleep at nine.", exJa: "わたしは 9じに ねます。" },
  { en: "need", ja: "～を必要とする,必要", emoji: "🙏", ex: "I need a new pen.", exJa: "わたしは あたらしい ペンが ひつようです。" },
  { en: "paint", ja: "ペンキをぬる,絵を描く,ペンキ,絵の具", emoji: "🎨", ex: "I paint a picture.", exJa: "わたしは えを かきます。" },

  // ===== 471〜480 =====
  { en: "rain", ja: "雨が降る,雨", emoji: "🌧️", ex: "It rains a lot in June.", exJa: "6がつは よく あめが ふります。" },
  { en: "call", ja: "呼ぶ,～と…呼ぶ,電話をかける", emoji: "📞", ex: "I call my friend.", exJa: "わたしは ともだちに でんわします。" },
  { en: "camp", ja: "キャンプする,キャンプ", emoji: "⛺", ex: "We camp in the mountains.", exJa: "わたしたちは やまで キャンプします。" },
  { en: "find", ja: "～を見つける,～だとわかる", emoji: "🔍", ex: "I find my key.", exJa: "わたしは かぎを みつけます。" },
  { en: "ski", ja: "スキーをする,スキーの板", emoji: "⛷️", ex: "I ski in winter.", exJa: "わたしは ふゆに スキーを します。" },
  { en: "think", ja: "考える,思う", emoji: "🤔", ex: "I think so.", exJa: "わたしも そう おもいます。" },
  { en: "tall", ja: "背が高い,～の背の高さの", emoji: "🦒", ex: "The giraffe is tall.", exJa: "きりんは せが たかいです。" },
  { en: "easy", ja: "やさしい,簡単な,気楽な", emoji: "😀", ex: "This test is easy.", exJa: "この テストは かんたんです。" },
  { en: "happy", ja: "幸せな,うれしい", emoji: "😊", ex: "I am happy.", exJa: "わたしは うれしいです。" },
  { en: "pretty", ja: "かわいい,きれいな", emoji: "🌸", ex: "This flower is pretty.", exJa: "この はなは きれいです。" },

  // ===== 481〜490 =====
  { en: "sunny", ja: "晴れの,日当たりのよい,快活な", emoji: "☀️", ex: "It is sunny today.", exJa: "きょうは はれです。" },
  { en: "cloudy", ja: "曇った,くもりの", emoji: "☁️", ex: "It is cloudy today.", exJa: "きょうは くもりです。" },
  { en: "rainy", ja: "雨の,雨降りの", emoji: "🌧️", ex: "It is rainy today.", exJa: "きょうは あめです。" },
  { en: "windy", ja: "風の強い,風の吹く", emoji: "🌬️", ex: "It is windy today.", exJa: "きょうは かぜが つよいです。" },
  { en: "snowy", ja: "雪の降る,雪の多い", emoji: "❄️", ex: "It is snowy today.", exJa: "きょうは ゆきです。" },
  { en: "young", ja: "若い", emoji: "👶", ex: "My father is young.", exJa: "わたしの ちちは わかいです。" },
  { en: "large", ja: "大きい,広い", emoji: "🐘", ex: "This room is large.", exJa: "この へやは ひろいです。" },
  { en: "slow", ja: "遅い,ゆっくりと", emoji: "🐢", ex: "The turtle is slow.", exJa: "かめは おそいです。" },
  { en: "fast", ja: "速く,速い", emoji: "⚡", ex: "He runs fast.", exJa: "かれは はやく はしります。" },
  { en: "busy", ja: "忙しい,混雑した", emoji: "🏃‍♀️", ex: "My mother is busy.", exJa: "おかあさんは いそがしいです。" },

  // ===== 491〜500 =====
  { en: "soft", ja: "やわらかい,おだやかな", emoji: "🧸", ex: "This bed is soft.", exJa: "この ベッドは やわらかいです。" },
  { en: "sweet", ja: "甘い,甘いもの", emoji: "🍬", ex: "This cake is sweet.", exJa: "この ケーキは あまいです。" },
  { en: "warm", ja: "暖かい,温かい", emoji: "🧣", ex: "It is warm today.", exJa: "きょうは あたたかいです。" },
  { en: "sleepy", ja: "眠い,眠そうな", emoji: "😪", ex: "I am sleepy.", exJa: "わたしは ねむいです。" },
  { en: "Italian", ja: "イタリア人の,イタリア語の", emoji: "🇮🇹", ex: "I like Italian food.", exJa: "わたしは イタリアりょうりが すきです。" },
  { en: "together", ja: "いっしょに", emoji: "🤝", ex: "We play together.", exJa: "わたしたちは いっしょに あそびます。" },
  { en: "Mrs.", ja: "～夫人,～さん,～先生", emoji: "👩", ex: "This is Mrs. Smith.", exJa: "こちらは スミスさんです。" },
  { en: "a.m.", ja: "午前", emoji: "🌅", ex: "It is seven a.m.", exJa: "ごぜん7じです。" },
  ...
  { en: "first", ja: "最初,最初の,最初に,1番目の", emoji: "🥇", ex: "This is my first time.", exJa: "これが はじめてです。" },
  { en: "second", ja: "2番目,第2の,秒", emoji: "🥈", ex: "This is my second book.", exJa: "これは 2さつめの 本ほんです。" },
  { en: "third", ja: "3番目,第3の", emoji: "🥉", ex: "This is my third try.", exJa: "これで 3かいめです。" },

  // ===== 531〜540 =====
  { en: "fourth", ja: "4番目の", emoji: "🔢", ex: "I am in fourth grade.", exJa: "わたしは 4ねんせいです。" },
  { en: "fifth", ja: "5番目の", emoji: "🔢", ex: "This is the fifth question.", exJa: "これは 5もんめです。" },
  { en: "sixth", ja: "6番目の", emoji: "🔢", ex: "This is the sixth day.", exJa: "きょうで 6にちめです。" },
  { en: "seventh", ja: "7番目の", emoji: "🔢", ex: "Today is the seventh.", exJa: "きょうは 7かです。" },
  { en: "eighth", ja: "8番目の", emoji: "🔢", ex: "Today is the eighth.", exJa: "きょうは 8かです。" },
  { en: "ninth", ja: "9番目の", emoji: "🔢", ex: "Today is the ninth.", exJa: "きょうは 9かです。" },
  { en: "tenth", ja: "10番目の", emoji: "🔢", ex: "Today is the tenth.", exJa: "きょうは 10かです。" },
  { en: "eleventh", ja: "11番目の", emoji: "🔢", ex: "Today is the eleventh.", exJa: "きょうは 11にちです。" },
  { en: "twelfth", ja: "12番目の", emoji: "🔢", ex: "Today is the twelfth.", exJa: "きょうは 12にちです。" },
  { en: "I", ja: "私は", emoji: "🙋", ex: "I am a student.", exJa: "わたしは せいとです。" },

  // ===== 541〜550 =====
  { en: "my", ja: "私の", emoji: "🙋", ex: "This is my bag.", exJa: "これは わたしの かばんです。" },
  { en: "me", ja: "私を[に]", emoji: "🙋", ex: "Look at me.", exJa: "わたしを みて。" },
  { en: "mine", ja: "私のもの", emoji: "🙋", ex: "This pen is mine.", exJa: "この ペンは わたしのです。" },
  { en: "you", ja: "あなたは,あなたたちは(主格)", emoji: "🧑", ex: "You are kind.", exJa: "あなたは しんせつです。" },
  { en: "your", ja: "あなたの", emoji: "🧑", ex: "This is your book.", exJa: "これは あなたの 本ほんです。" },
  { en: "you", ja: "あなたに[を](目的格)", emoji: "🧑", ex: "I know you.", exJa: "わたしは あなたを しっています。" },
  { en: "yours", ja: "あなた(がた)のもの", emoji: "🧑", ex: "This bag is yours.", exJa: "この かばんは あなたのです。" },
  { en: "he", ja: "彼は", emoji: "👦", ex: "He is my brother.", exJa: "かれは わたしの きょうだいです。" },
  { en: "his", ja: "彼の(所有格)", emoji: "👦", ex: "This is his bike.", exJa: "これは かれの じてんしゃです。" },
  { en: "him", ja: "彼を[に]", emoji: "👦", ex: "I know him.", exJa: "わたしは かれを しっています。" },

  // ===== 551〜560 =====
  { en: "his", ja: "彼のもの(所有代名詞)", emoji: "👦", ex: "This bike is his.", exJa: "この じてんしゃは かれのです。" },
  { en: "she", ja: "彼女は", emoji: "👧", ex: "She is my sister.", exJa: "かのじょは わたしの しまいです。" },
  { en: "her", ja: "彼女の(所有格)", emoji: "👧", ex: "This is her bag.", exJa: "これは かのじょの かばんです。" },
  { en: "her", ja: "彼女を[に](目的格)", emoji: "👧", ex: "I know her.", exJa: "わたしは かのじょを しっています。" },
  { en: "hers", ja: "彼女のもの", emoji: "👧", ex: "This bag is hers.", exJa: "この かばんは かのじょのです。" },
  { en: "it", ja: "それは(主格)", emoji: "📦", ex: "I like it.", exJa: "わたしは それが すきです。" },
  { en: "its", ja: "その", emoji: "📦", ex: "The dog wags its tail.", exJa: "いぬは しっぽを ふります。" },
  { en: "it", ja: "それを[に](目的格)", emoji: "📦", ex: "I have it.", exJa: "わたしは それを もっています。" },
  { en: "we", ja: "私たちは", emoji: "👨‍👩‍👧", ex: "We are friends.", exJa: "わたしたちは ともだちです。" },
  { en: "our", ja: "私たちの", emoji: "👨‍👩‍👧", ex: "This is our school.", exJa: "これは わたしたちの がっこうです。" },

  // ===== 561〜570 =====
  { en: "us", ja: "私たちを[に]", emoji: "👨‍👩‍👧", ex: "Help us.", exJa: "わたしたちを たすけて。" },
  { en: "ours", ja: "私たちのもの", emoji: "👨‍👩‍👧", ex: "This house is ours.", exJa: "この いえは わたしたちのです。" },
  { en: "they", ja: "彼らは,彼女たちは,それらは", emoji: "👥", ex: "They are my friends.", exJa: "かれらは わたしの ともだちです。" },
  { en: "their", ja: "彼らの,それらの", emoji: "👥", ex: "This is their house.", exJa: "これは かれらの いえです。" },
  { en: "them", ja: "彼らに[を],それらに[を]", emoji: "👥", ex: "I know them.", exJa: "わたしは かれらを しっています。" },
  { en: "theirs", ja: "彼らのもの,それらのもの", emoji: "👥", ex: "This bag is theirs.", exJa: "この かばんは かれらのです。" },
  ...
  { en: "come from", ja: "～の出身である", emoji: "🌍", ex: "I come from Japan.", exJa: "わたしは にほんの しゅっしんです。" },
  { en: "come to", ja: "～に来る", emoji: "➡️", ex: "Come to my house.", exJa: "わたしの いえに きて。" },
  { en: "do one's homework", ja: "宿題をする", emoji: "📝", ex: "I do my homework.", exJa: "わたしは しゅくだいを します。" },
  { en: "get up", ja: "起きる,立ち上がる", emoji: "⏰", ex: "I get up at seven.", exJa: "わたしは 7じに おきます。" },

  // ===== 571〜580 =====
  { en: "go doing", ja: "～しに行く", emoji: "🚶", ex: "I go fishing.", exJa: "わたしは つりに いきます。" },
  { en: "go home", ja: "家に帰る", emoji: "🏠", ex: "I go home at five.", exJa: "わたしは 5じに いえに かえります。" },
  { en: "go to", ja: "～へ行く", emoji: "➡️", ex: "I go to school.", exJa: "わたしは がっこうへ いきます。" },
  { en: "like doing", ja: "～することが好きである", emoji: "❤️", ex: "I like swimming.", exJa: "わたしは およぐことが すきです。" },
  { en: "listen to", ja: "～を聞く", emoji: "👂", ex: "I listen to music.", exJa: "わたしは おんがくを ききます。" },
  { en: "live in", ja: "～に住んでいる", emoji: "🏠", ex: "I live in Tokyo.", exJa: "わたしは とうきょうに すんでいます。" },
  { en: "look at", ja: "～を見る", emoji: "👀", ex: "Look at this.", exJa: "これを みて。" },
  { en: "sit down", ja: "座る", emoji: "🪑", ex: "Please sit down.", exJa: "すわって ください。" },
  { en: "sleep in bed", ja: "ベッドで眠る", emoji: "🛏️", ex: "I sleep in bed.", exJa: "わたしは ベッドで ねます。" },
  { en: "speak to", ja: "～と話す", emoji: "🗣️", ex: "I speak to my teacher.", exJa: "わたしは 先生せんせいと はなします。" },

  // ===== 581〜590 =====
  { en: "stand up", ja: "立ち上がる", emoji: "🧍", ex: "Please stand up.", exJa: "たって ください。" },
  { en: "take a picture", ja: "写真を撮る", emoji: "📸", ex: "I take a picture.", exJa: "わたしは しゃしんを とります。" },
  { en: "take a shower", ja: "シャワーを浴びる", emoji: "🚿", ex: "I take a shower.", exJa: "わたしは シャワーを あびます。" },
  { en: "talk about", ja: "～について話す", emoji: "💬", ex: "I talk about my dog.", exJa: "わたしは いぬについて はなします。" },
  { en: "a cup of", ja: "1杯の～", emoji: "☕", ex: "I want a cup of tea.", exJa: "わたしは おちゃが 1ぱい ほしいです。" },
  { en: "a glass of", ja: "コップ一杯の～", emoji: "🥛", ex: "I want a glass of water.", exJa: "わたしは みずが 1ぱい ほしいです。" },
  { en: "a lot of", ja: "たくさんの～", emoji: "💯", ex: "I have a lot of books.", exJa: "わたしは 本ほんを たくさん もっています。" },
  { en: "after school", ja: "放課後", emoji: "🏫", ex: "I play soccer after school.", exJa: "わたしは ほうかご サッカーを します。" },
  { en: "at home", ja: "家で,家に", emoji: "🏠", ex: "I study at home.", exJa: "わたしは いえで べんきょうします。" },
  { en: "at school", ja: "学校で", emoji: "🏫", ex: "I study at school.", exJa: "わたしは がっこうで べんきょうします。" },

  // ===== 591〜600 =====
  { en: "from A to B", ja: "AからBまで", emoji: "➡️", ex: "I walk from home to school.", exJa: "わたしは いえから がっこうまで あるきます。" },
  { en: "in the morning", ja: "朝に,午前中に", emoji: "🌅", ex: "I study in the morning.", exJa: "わたしは あさ べんきょうします。" },
  { en: "on TV", ja: "テレビで", emoji: "📺", ex: "I watch soccer on TV.", exJa: "わたしは テレビで サッカーを みます。" },
  { en: "on weekends", ja: "毎週末に", emoji: "🎉", ex: "I play tennis on weekends.", exJa: "わたしは まいしゅうまつ テニスを します。" },
  { en: "over there", ja: "向こうに,あそこに", emoji: "📍", ex: "Look over there.", exJa: "あそこを みて。" },
  { en: "years old", ja: "～歳", emoji: "🎂", ex: "I am eight years old.", exJa: "わたしは 8さいです。" },
];
